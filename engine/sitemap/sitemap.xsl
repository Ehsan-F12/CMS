	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				...
				#intro { background-color: #ffe2d5; border: 1px #a6a6a6 solid; padding: 5px 13px 5px 13px; margin: 10px; }
			...
			<body>
				...
				<div id="intro">
					<p>
						...
						It was generated using Apadana Cms Software <a href="http://www.apadanacms.ir/">Apadana Cms</a> <br/>
				...
				<div id="footer">
					Generated with <a href="http://www.apadanacms.ir/" title="Sitemap Generator">Apadana Cms Sitemap Generator</a> by <a href="http://www.apadanacms.ir/">Iman Moodi</a>. This XSLT template is released under GPL.
				</div>
			</body>
		</html>
	</xsl:template>
