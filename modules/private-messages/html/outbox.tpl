[list]<table class="apadana-table" id="apadana-private-messages-outbox" cellpadding="0" cellspacing="0">
<thead>
  <tr>
    <th align="right">عنوان</th>
    <th width="100">گیرنده</th>
...
[/list]
[not-list]{function name="message" args="هیچ پیام ارسالی وجود ندارد!|info"}[/not-list]
